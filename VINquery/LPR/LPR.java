...
public class LPR {
    public static void main(String[] args) {
        ...
        final String urlString = "http://www.recognition.ws/lpr/v1?accesscode=ACCESS_CODE";
        try {
    ...
    public static void postImage(HttpURLConnection con, String filePath) {
        ...
        try {
            ...
            pw.append("Content-Disposition: form-data; name\"file\"; filename=\"" + "\"").append(CRLF);
    ...
    public static void parseXML(HttpURLConnection con) {
        try {
            ...
            while (eventReader.hasNext()) {
                String print = "License Plate Captured: ";
                while (eventReader.hasNext()) {
                    XMLEvent event = eventReader.nextEvent();
                    if (event.isStartElement()) {
                        StartElement start = event.asStartElement();
                        if (start.getName().getLocalPart() == "License_Number") {
